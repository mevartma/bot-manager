package info.mashasha.bot_manger.web.rest;

import info.mashasha.bot_manger.config.Constants;
import info.mashasha.bot_manger.BotManagerApp;
import info.mashasha.bot_manger.domain.Authority;
import info.mashasha.bot_manger.domain.PersistentToken;
import info.mashasha.bot_manger.domain.User;
import info.mashasha.bot_manger.repository.AuthorityRepository;
import info.mashasha.bot_manger.repository.PersistentTokenRepository;
import info.mashasha.bot_manger.repository.UserRepository;
import info.mashasha.bot_manger.security.AuthoritiesConstants;
import info.mashasha.bot_manger.service.MailService;
import info.mashasha.bot_manger.service.dto.UserDTO;
import info.mashasha.bot_manger.service.dto.PasswordChangeDTO;
import info.mashasha.bot_manger.web.rest.errors.ExceptionTranslator;
import info.mashasha.bot_manger.web.rest.vm.KeyAndPasswordVM;
import info.mashasha.bot_manger.web.rest.vm.ManagedUserVM;
import info.mashasha.bot_manger.service.UserService;
...
@SpringBootTest(classes = BotManagerApp.class)
